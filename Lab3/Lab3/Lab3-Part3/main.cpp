...
void DisplayState(SDL_JoyButtonEvent *button)
{
...
int main(int argc, char *argv[])
{
	...
	while (!done)
	{
		...
		//handles the joystick movement outside of event polling for the first joystick
		if (joy)
		{
		...
		//handles the joystick movement outside of event polling for the second joystick
		if (joy2)
		{
